...
$result_laporan = query("SELECT * FROM laporan WHERE status = 'belum diproses'");
?>
...
<head>
    ...
    <title>SIMPANAN | Laporan Belum Diproses</title>
...
<body class="sb-nav-fixed">
            ...
            <main>
                <div class="container-fluid px-4">
                    ...
                    <ol class="breadcrumb mb-4">
                        ...
                        <li class="breadcrumb-item active">Belum Diproses</li>
                    </ol>
    ...
    <script>
        ...
        const nav_link_semua_laporan = document.getElementById('nav-link-belum-diproses');
