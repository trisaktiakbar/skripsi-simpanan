        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4">Tambah Tersangka</h1>
                                                    ...
                                                    <div>
                                                        <label for="foto" class="w-100">
                                                            <div class="text-center">
                                                                <img id="foto-preview" src="<?= $BASE_URL ?>assets/img/foto-preview.png" alt="" class="w-100 object-fit-cover w-100 rounded-3 border border-1 mb-3 cursor-pointer">
                                                            </div>
                                                        </label>
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <div class="mb-4">
                                                    ...
                                                    <input type="text" class="form-control" id="nama-lengkap" name="nama-lengkap" aria-describedby="nama-lengkap" placeholder="Nama Lengkap" required>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="mb-4">
                                                    ...
                                                    <input type="text" class="form-control" id="tempat-lahir" name="tempat-lahir" aria-describedby="tempat-lahir" placeholder="Kota/Kabupaten">
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="mb-3">
                                                    <label for="tanggal-lahir" class="form-label">Tanggal Lahir</label>
                                                    <input type="date" class="form-control" id="tanggal-lahir" name="tanggal-lahir" aria-describedby="tanggal-lahir">
                                                </div>
                                            </div>
                                                ...
                                                <div class="row">
                                                    <div class="col">
                                                        <div class="mb-4">
                                                            ...
                                                            <input type="text" class="form-control" id="domisili" name="domisili" aria-describedby="domisili" placeholder="Kota/Kabupaten">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
