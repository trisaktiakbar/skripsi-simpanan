...
if (isset($_POST['submit'])) {
    ...
    mysqli_query(
        $conn,
        "INSERT INTO perkembangan_kasus (
        judul,
        deskripsi,
        kode_laporan
        ) VALUES (
...
<head>
    ...
    <title>SIMPANAN | Tambah Perkembangan Kasus</title>
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4">Tambah Perkembangan Kasus</h1>
                    <ol class="breadcrumb mb-4">
                        ...
                        <li class="breadcrumb-item active">Tambah Perkembangan Kasus</li>
                    </ol>
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="mb-4">
                                            ...
                                            <input type="text" class="form-control" id="judul" name="judul" aria-describedby="judul" placeholder="Judul">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="mb-4">
                                            ...
                                            <textarea type="text" class="form-control" id="deskripsi" name="deskripsi" aria-describedby="deskripsi" placeholder="Deskripsi" rows="10"></textarea>
                                        </div>
                                    </div>
                                </div>
