...
$result = mysqli_query($conn, "SELECT id FROM barang_bukti WHERE kode_laporan='$kode_laporan' AND id='$id'");

if (!mysqli_fetch_assoc($result)) {
    header('Location: ..');
} else {
    mysqli_query($conn, "DELETE FROM barang_bukti WHERE kode_laporan='$kode_laporan' AND id='$id'");
