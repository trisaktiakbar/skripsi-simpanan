...
$result_laporan = query("SELECT * FROM laporan WHERE status = 'sementara proses'");
?>
...
<head>
    ...
    <title>SIMPANAN | Laporan Sementara Proses</title>
...
<body class="sb-nav-fixed">
            ...
            <main>
                <div class="container-fluid px-4">
                    ...
                    <ol class="breadcrumb mb-4">
                        ...
                        <li class="breadcrumb-item active">Sementara Proses</li>
                    </ol>
    ...
    <script>
        ...
        const nav_link_semua_laporan = document.getElementById('nav-link-sementara-proses');
