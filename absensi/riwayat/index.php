...
$result_absensi = query("SELECT * FROM absensi INNER JOIN user ON absensi.kode_user = user.id WHERE user.username = '$username'");
?>
...
<body class="sb-nav-fixed">
    ...
    <script>
        ...
        const nav_link_riwayat = document.getElementById('nav-link-riwayat');
        nav_link_riwayat.classList.add('active');
    </script>
</body>
